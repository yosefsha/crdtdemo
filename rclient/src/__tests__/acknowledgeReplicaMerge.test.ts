...
import { Document } from "@crdtdemo/shared/crdt/database/Document";
import { CollectionDelta } from "@crdtdemo/shared/crdt/database/Collection";
...
describe("Document.acknowledgeReplicaMerge", () => {
  ...
  describe("Missing deltas acknowledgment", () => {
    it("should also acknowledge missing deltas (what replica sent)", () => {
      ...
      const missingDeltas: CollectionDelta<string>[] = [
        {
          itemId: "2,2",
          value: "00ff00ff",
          timestamp: 101,
  ...
  describe("Edge cases", () => {
    ...
    it("should handle large number of items", () => {
      ...
      // Add 1000 items
      const items: CollectionDelta<string>[] = [];
